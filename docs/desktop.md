...
Niri and MangoWC source a personal override file generated by home-manager at the very end of their config — **never touched by `git pull`**:
...
For Niri and MangoWC, set your monitors, keybinds, and tweaks in `home/local.nix`:
...
> See `home/local.nix.example` for the full list of examples (Niri, MangoWC).
