...
-- ─── Noctalia Shell ───
hl.bind(mod .. " SHIFT + ESCAPE", hl.dsp.exec("caelestia-shell ipc call drawers toggle overview"))
hl.bind(mod .. " SHIFT + Q",      hl.dsp.exec("caelestia-shell ipc call drawers toggle session"))

-- ─── Applications ───
hl.bind(mod .. " + RETURN",       hl.dsp.exec("ghostty"))
hl.bind(mod .. " + D",            hl.dsp.exec("caelestia-shell ipc call drawers toggle launcher"))
hl.bind(mod .. " + B",            hl.dsp.exec("zen-beta"))
hl.bind(mod .. " SHIFT + B",      hl.dsp.exec("brave"))
hl.bind(mod .. " ALT + L",        hl.dsp.exec("caelestia-shell ipc call lock lock"))
...
hl.bindel(" + XF86AudioRaiseVolume", hl.dsp.exec("wpctl set-mute @DEFAULT_AUDIO_SINK@ 0; wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+"))
hl.bindel(" + XF86AudioLowerVolume", hl.dsp.exec("wpctl set-mute @DEFAULT_AUDIO_SINK@ 0; wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-"))
hl.bindl(" + XF86AudioMute",         hl.dsp.exec("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle"))
hl.bindl(" + XF86AudioMicMute",      hl.dsp.exec("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"))
