{ pkgs, lib, config, osConfig, roudixSwitch, dotfiles, ... }:
{
 ...
 # ── Personal Home Manager overrides ─────────────────────────────────────
  ...
  # programs.umbriel.settings.keybinds."Mod+C" = lib.mkForce "spawn:some-command";
    programs.umbriel.settings.keybinds."Mod+Y" = lib.mkForce "spawn:noctalia msg panel-toggle aabidk20/yt-music:panel";
