...
Si de nouveaux commits sont détectés sur `main`, il fait un pull et lance `nh os boot path:...` — la nouvelle config s'applique au prochain redémarrage.
...
{ ... }:
{
  ...
  roudix.autoupdate.branch   = "main"; # branche à suivre
}
```
