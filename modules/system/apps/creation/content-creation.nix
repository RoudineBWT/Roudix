...
in
{
  options.roudix.contentCreation = {
    ...
    obs = {
      ...
      # that's what the wrapOBS in `modules/home/apps/creation/content-creation.nix` consumes.
    ...
    videoEditor = lib.mkOption {
      ...
      default = "kdenlive";
      description = ''
        Video editor installed (see `modules/home/apps/creation/content-creation.nix`).
