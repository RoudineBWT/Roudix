...
-- ─── Noctalia Shell ───
hl.bind(mod .. " SHIFT + ESCAPE", hl.dsp.exec("dms ipc call hypr toggleBinds"))
hl.bind(mod .. " SHIFT + Q",      hl.dsp.exec("dms ipc call powermenu toggle"))

-- ─── Applications ───
hl.bind(mod .. " + RETURN",       hl.dsp.exec("ghostty"))
hl.bind(mod .. " + D",            hl.dsp.exec("dms ipc call spotlight toggle"))
hl.bind(mod .. " + B",            hl.dsp.exec("zen-beta"))
hl.bind(mod .. " SHIFT + B",      hl.dsp.exec("brave"))
hl.bind(mod .. " ALT + L",        hl.dsp.exec("dms ipc call lock lock"))
...
hl.bindel(" + XF86AudioRaiseVolume", hl.dsp.exec("dms ipc call audio increment 3"))
hl.bindel(" + XF86AudioLowerVolume", hl.dsp.exec("dms ipc call audio decrement 3"))
hl.bindl(" + XF86AudioMute",         hl.dsp.exec("dms ipc call audio mute"))
hl.bindl(" + XF86AudioMicMute",      hl.dsp.exec("dms ipc call audio micmute"))
