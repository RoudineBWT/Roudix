...
{ ... }:
{
  ...
  binds = {
    ...
    "Mod+D" = { hotkey-overlay.title = "Open App Launcher: DMS Spotlight"; action.spawn-sh = [ "dms ipc call spotlight toggle" ]; };
    "Mod+B" = { hotkey-overlay.title = "Open Browser: Zen"; action.spawn = [ "zen-twilight" ]; };
    "Mod+Shift+B" = { hotkey-overlay.title = "Open Browser: brave"; action.spawn = [ "brave" ]; };
    "Mod+Alt+L" = { hotkey-overlay.title = "Lock Screen: DMS lock"; action.spawn-sh = [ "dms ipc call lock lock" ]; };
    "Mod+E" = { hotkey-overlay.title = "File Manager: Nautilus"; action.spawn = [ "nautilus" ]; };
    "Mod+Shift+Q".action.spawn-sh = [ "dms ipc call powermenu toggle" ];

    # ─── Audio ───
    "XF86AudioRaiseVolume" = { allow-when-locked = true; action.spawn-sh = [ "dms ipc call audio increment 3" ]; };
    "XF86AudioLowerVolume" = { allow-when-locked = true; action.spawn-sh = [ "dms ipc call audio decrement 3" ]; };
    "XF86AudioMute" = { allow-when-locked = true; action.spawn-sh = [ "dms ipc call audio mute" ]; };
    "XF86AudioMicMute" = { allow-when-locked = true; action.spawn-sh = [ "dms ipc call audio micmute" ]; };
